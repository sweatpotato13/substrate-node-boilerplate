...
LABEL description="Multistage Docker image for Substrate Node Template" \
  image.type="builder" \
  image.authors="sweatpotato13@email.com" \
  image.vendor="" \
  image.description="Multistage Docker image for Substrate Node Template" \
  image.source="https://github.com/sweatpotato13/substrate-node-boilerplate" \
  image.documentation="https://github.com/sweatpotato13/substrate-node-boilerplate"
